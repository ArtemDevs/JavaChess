...
public abstract class Square {
  ...
  private static final Map<Integer, EmptySquare> EMPTY_SQUARE_CACHE =
      createAllPossibleEmptySquares();
  ...
  public static Square createSquare(final int squareCord, final Piece piece) {
    return piece != null
        ? new OccupiedSquare(squareCord, piece)
        : EMPTY_SQUARE_CACHE.get(squareCord);
  }
